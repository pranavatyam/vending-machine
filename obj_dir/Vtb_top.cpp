...
Vtb_top::Vtb_top(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , prstn{vlSymsp->TOP.prstn}
    , cfg_mode{vlSymsp->TOP.cfg_mode}
    , currency_valid{vlSymsp->TOP.currency_valid}
    , currency_value{vlSymsp->TOP.currency_value}
    , item_select_valid{vlSymsp->TOP.item_select_valid}
    , no_of_items{vlSymsp->TOP.no_of_items}
    , psel{vlSymsp->TOP.psel}
    , pwrite{vlSymsp->TOP.pwrite}
    , pready{vlSymsp->TOP.pready}
    , item_dispense_valid{vlSymsp->TOP.item_dispense_valid}
    , no_of_items_out{vlSymsp->TOP.no_of_items_out}
    , item_select{vlSymsp->TOP.item_select}
    , item_dispense{vlSymsp->TOP.item_dispense}
    , currency_change{vlSymsp->TOP.currency_change}
